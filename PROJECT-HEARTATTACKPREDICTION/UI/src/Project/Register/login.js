...
import Axios from '../AttackPrediction/axios'
...
render()
{
    return(
      ...
      {state=>
        ...
        modalBody={this.state.modalBody} modalTitle={this.state.modalTitle} submit={ this.props.inputHandler1(this.arr)} />
      }
      </Transition>
      <Backdrop show={this.state.show}/>
       ...
       <button style={{marginLeft:'150px',marginTop:'50px'}}class="btn btn-success" onClick={this.checking} >SUBMIT</button>
        </div>
    )
}
